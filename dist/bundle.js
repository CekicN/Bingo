...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/operators/take.js");
...
class BingoGame {
    constructor() {
        ...
        this.numbers = new rxjs__WEBPACK_IMPORTED_MODULE_0__.Subject();
    }
    startGame() {
        this.generateNumbers().pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.take)(75)).subscribe((number) => {
    ...
    generateNumbers() {
        numberGenerator$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.interval)(100).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.map)(() => Math.floor(Math.random() * 90 + 1)), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.distinct)(), (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.scan)((acc, curr) => {
...
startBtn.addEventListener('click', () => {
    bingo.userSubject.subscribe((user) => {
        console.log("Pocelo");
        drawTable(user);
        let winner = new rxjs__WEBPACK_IMPORTED_MODULE_1__.BehaviorSubject(0);
...
function drawTable(user) {
    ...
    let usernameText = document.querySelector('h3');
